...
toteBettingControllers.controller('HeaderCtrl', function ($scope) {
  
});


toteBettingControllers.controller('PageCtrl', ['$scope', 'dividentService', function ($scope, dividentService) {
  $scope.bets = {};
  $scope.bets.wBets = [
  	"W:1:3",
  	"W:2:4",
